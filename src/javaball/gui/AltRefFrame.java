...
public final class AltRefFrame extends JFrame implements ActionListener {
	 ...
	 */
        public void setLocations() {
            northCheckbox
                    .setSelected(controller.travelPreference(referee, Location.NORTH));
            centralCheckbox.setSelected(controller.travelPreference(referee,
                    Location.CENTRAL));
            southCheckbox
                    .setSelected(controller.travelPreference(referee, Location.SOUTH));
        }
